        ...
        <div className="flex flex-col my-5 gap-5">
          ...
          <div className="p-5 border rounded-lg border-yellow-300 bg-yellow-100">
            ...
            <h2 className="mt-3 text-yellow-500">
              Enable Video Web Camera and Microphone to Start your AI Generated
              Mock Interview, It Has 5 questions.
              <br />
              <span className="text-red-500">Note:</span> We never record your
